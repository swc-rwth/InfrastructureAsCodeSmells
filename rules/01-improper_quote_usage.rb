rule 'JUL010', 'Do not quote Booleans' do
...
rule 'JUL011', 'Do not use variables in single quoted string --> Unguarded Variable smell wont get detected properly' do
...
rule 'JUL012', 'Quote resource titles' do
  tags %w{style improper_quote_usage}
  cookbook do |path|
